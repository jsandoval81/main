...
var WEBAPP=function(){this.isTouch="ontouchstart"in window,this.isdevice=!!navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry)/),this.setUpRequestAnimationFrame(),this.animationarray=[],this.header=new HEADERSCALE(this,"header","content-container"),this.projects=new PROJECTS,this.scrollAnimation()};WEBAPP.prototype.setUpRequestAnimationFrame=function(){for(var e=["ms","moz","webkit","o",""],t=0;t<e.length&&!window.requestAnimationFrame;++t)window.requestAnimationFrame=window[e[t]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[e[t]+"CancelAnimationFrame"]||window[e[t]+"CancelRequestAnimationFrame"]},WEBAPP.prototype.scrollAnimation=function(){function e(){for(var e=0;e<t.animationarray.length;e++)t.animationarray[e].animate()}var t=this;if(!oldieishere&&!t.isTouch&&$(window).width()>1024){for(var i=$(".skill-item"),n=0;n<i.length;n++){var o=$(i[n]);t.animationarray.push(new slideableelement(o,"bottom",{css:{scale:0,opacity:0}}))}$(document).on("scroll",window,function(){e()}),e()}};var PROJECTS=function(){this.projects=$(".skill-item"),this.projects.hover(function(){var e=$(this);e.addClass("hover"),TweenMax.fromTo(e.find(".mask"),.6,{opacity:0,display:"none"},{opacity:.85,display:"block"}),TweenMax.fromTo(e.find(".info"),.6,{opacity:0,display:"none"},{opacity:1,display:"table-cell"})},function(){var e=$(this);e.removeClass("hover"),TweenMax.to(e.find(".mask"),.6,{opacity:0,display:"none"}),TweenMax.to(e.find(".info"),.6,{opacity:0,display:"none"})}),this.projects.on("click",function(){var e=$(this).find("a").attr("href");window.open?window.open(e,"_blank"):window.location=e})},HEADERSCALE=function(e,t,i){var n=this;this.parent=e,this.elem=document.getElementById(t),this.nextContainer=document.getElementById(i),this.windowWidth,this.windowHeight,this.height,this.minMobileHeight=300,this.minDesktopHeight=500,this.resizeContainer(),$(window).resize(function(){n.resizeContainer()})};HEADERSCALE.prototype.resizeContainer=function(){this.windowWidth=$(window).width(),this.windowHeight=$(window).height(),this.height=this.windowWidth>550?this.windowHeight.limit(this.minDesktopHeight,1485):this.windowHeight.limit(this.minMobileHeight,1485),this.elem.style.width=this.windowWidth+"px",this.elem.style.height=this.height+"px",this.nextContainer.style.marginTop=this.height+"px"};var slideableelement=function(e,t,i,n){this.elem=e,this.elemtrigger=void 0===n?e:n,this.offsetTop=this.elemtrigger.offset().top,this.elemheight=this.elemtrigger.height(),this.interval=null,this.timeout=null,this.previouspercentage=0,this.percentage=0,this.tl=new TimelineMax({smoothChildTiming:!0}),this.tl.staggerFrom(e,3,i,1),this.tl.pause(),this.speed=.02,this.wheretostartanimation=t,this.wheretostartanimationnumber=0};slideableelement.prototype.animate=function(){function e(){var i=(new Date).getTime(),n=i-(r||i);window.requestAnimationFrame?s=requestAnimationFrame(e):(window.clearTimeout(t.timeout),t.timeout=null,t.timeout=setTimeout(function(){e()},1)),r=i,t.previouspercentage=t.percentage>t.previouspercentage?(t.previouspercentage+=.003*n).limit(0,t.percentage):(t.previouspercentage-=.003*n).limit(t.percentage,1),t.tl.progress(t.previouspercentage),t.previouspercentage==t.percentage&&(window.requestAnimationFrame?cancelAnimationFrame(s):(window.clearTimeout(t.timeout),t.timeout=null),t.previouspercentage=t.percentage)}var t=this,i=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop,n=0,o=1,a=t.elemtrigger.height();switch(t.wheretostartanimation){case"top":t.wheretostartanimationnumber=i+Math.floor($(window).height()/4);break;case"center":t.wheretostartanimationnumber=i+Math.floor($(window).height()/2),n=t.elemtrigger.height()/2,o=n;break;case"bottom":t.wheretostartanimationnumber=i+Math.floor($(window).height()/1.15)}if($.browser.msie&&10==$.browser.version)t.percentage=t.wheretostartanimationnumber-(t.offsetTop-t.elemtrigger.height()/2),t.percentage=(t.percentage.map(-o,a,0,100)/100).limit(0,1),t.tl.progress(t.percentage);else{t.percentage=t.wheretostartanimationnumber-(t.elemtrigger.offset().top+n),t.percentage=(t.percentage.map(-o,a,0,100)/100).limit(0,1);var r,s;e()}},slideableelement.prototype.endanimation=function(){this.elem.attr("style","")},Number.prototype.map=function(e,t,i,n){return i+(n-i)*((this-e)/(t-e))},Number.prototype.limit=function(e,t){return Math.min(t,Math.max(e,this))},$(document).ready(function(){new WEBAPP;$("#skills-preview").masonry({itemSelector:".skill-item",isResizable:!0,isFitWidth:!0,isAnimated:!0,columnWidth:185})}),window.onload=function(){$("body").addClass("animate-all")};